...
function ShareMatchButton({ nolan, topMatches }: { nolan: ReturnType<typeof calculateNolanChart>; topMatches: Array<PerfilPublico & { score: number }> }) {
  ...
  return (
    <button
      onClick={handleShare}
      className="bg-[#25d366] border-4 border-black font-headline font-black px-6 py-4 uppercase text-lg hover:brightness-110 w-full md:w-auto text-center flex items-center justify-center gap-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all"
    >
