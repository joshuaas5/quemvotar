    ...
    <footer className="w-full py-12 px-6 flex flex-col md:flex-row justify-between items-center gap-8 bg-[#e0e3e4] border-t-4 border-black">
      <div className="flex flex-col items-center md:items-start gap-4">
        ...
        <p className="font-body font-bold uppercase text-sm text-black max-w-md text-center md:text-left">
          © {new Date().getFullYear()} QUEM VOTAR. PLATAFORMA INDEPENDENTE. DADOS: TSE / CONGRESSO NACIONAL.
        </p>
      </div>
      ...
      <div className="flex gap-4">
        <div className="w-10 h-10 border-2 border-black bg-on-background flex items-center justify-center text-white cursor-pointer hover:bg-secondary hover:-translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all">
