  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 md:space-y-10">
      <PageHero
        ...
        description="Encontre deputados e senadores por nome, partido, UF e casa legislativa."
        accent="cyan"
        stat={{ value: parlamentares.length.toLocaleString('pt-BR'), label: 'Perfis carregados das fontes públicas disponíveis.' }}
      />

      <form
        onSubmit={handleSubmit}
        className="bg-[#FFD709] border-4 border-black p-4 md:p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-3 md:gap-4"
      >
        <input
          type="text"
          value={q}
      ...
      {resultados.length === 0 ? (
        ...
        <>
          ...
          className="bg-[#9BF6FF] border-4 border-black font-headline font-black px-8 py-4 uppercase text-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all"
              >
                Carregar mais 24
              </button>
            </div>
