  ...
  return (
    <nav className="flex justify-between items-center w-full px-6 py-4 sticky top-0 z-50 bg-[#f5f6f7] border-b-4 border-black neo-brutalist-shadow">
      ...
      <div className="hidden md:flex gap-8 items-center font-headline font-black uppercase tracking-tighter">
        <Link href="#busca" className="text-black border-b-4 border-black pb-1 active:scale-95 cursor-pointer">
          Busca
        </Link>
        <Link href="#candidatos" className="text-black/60 hover:text-black hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all duration-75 active:scale-95 cursor-pointer">
          Perfis
        </Link>
