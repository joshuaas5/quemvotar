import { getCasaBadge, getFonteBadge, searchCandidatos } from '@/lib/api';
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {resultados.length === 0 ? (
            <div className="bg-white border-4 border-black p-12 text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              ...
              <h2 className="font-headline font-black text-3xl uppercase">Nenhum perfil oficial encontrado</h2>
              ...
              {resultados.map((c) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col justify-center">
                    ...
                    <span className="font-label font-bold text-[11px] uppercase opacity-70">
                      {getFonteBadge(c)}
                    </span>
                  </div>
                </article>
